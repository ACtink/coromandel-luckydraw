...
function SixthPrize() {
  ...
  const winnersList = [
    {
      url: "/lucky-draw-files/winner_data/mixer_winner/1.jpg",
      title: "beach",
    },
    {
      url: "/lucky-draw-files/winner_data/mixer_winner/2.jpg",
      title: "beach",
    },
  ];
  ...
  return (
    <div className="grandpage">
      ...
      <div className="image-container">
        <img
          src="/lucky-draw-files/Screens/mixer_screen_1.jpg"
