...
function SeventhPrize() {
  ...
  const winnersList = [
    {
      url: "/lucky-draw-files/winner_data/pump_winner/1.jpg",
      title: "beach",
    },
    {
      url: "/lucky-draw-files/winner_data/pump_winner/2.jpg",
      title: "beach",
    },
    {
      url: "/lucky-draw-files/winner_data/pump_winner/3.jpg",
      title: "beach",
    },
    {
      url: "/lucky-draw-files/winner_data/pump_winner/4.jpg",
      title: "beach",
    },
    {
      url: "/lucky-draw-files/winner_data/pump_winner/5.jpg",
      title: "beach",
    },
  ];
  ...
  return (
    <div className="grandpage">
      ...
      <div className="image-container">
        <img
          src="/lucky-draw-files/Screens/pump_screen_1.jpg"
      ...
      <div className="grandprize-down-portion image-container">
        <img
          ...
          src="/lucky-draw-files/Screens/pump_screen_2.png"
          alt=""
          onLoad={(e) => {
            const container = e.target.parentElement; // Select the parent element
            container.classList.add("loaded"); // Add the 'loaded' class to the container
